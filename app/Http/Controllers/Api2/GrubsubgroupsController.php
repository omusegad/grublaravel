...
class GrubsubgroupsController extends Controller
{
    /**
    ...
    {
    //    $data = Corporatesubscriptiongroups::with('corporateusers')->get()->toArray();
    //    return $data;
    ...
    // register user to corporate user during segister group
    ...
    private function getOderHistory($data){
        $history = Corporatemealsweekly::where('iUserId', $data['iUserId'])
                                        ->get();
        return $history;
    }
