...
class CreateConfigurationsPaymentTable extends Migration {
	...
	public function up()
	{
		Schema::create('configurations_payment', function(Blueprint $table)
		{
	...
	{
		Schema::drop('configurations_payment');
	}
